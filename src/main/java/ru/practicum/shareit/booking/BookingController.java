...
public class BookingController {
    ...
    public BookingDto createBooking(@Valid @RequestBody RequestBookingCreate request,
    ...
    @GetMapping
    @ResponseStatus(HttpStatus.OK)
    public List<BookingDto> getBookingListFromUser(@RequestParam(defaultValue = "ALL") State state,
                                                   @RequestHeader(name = USER_ID_HEADER) long userId) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public List<BookingDto> getBookingListFromState(@RequestParam(defaultValue = "ALL") State state,
                                                    @RequestHeader(name = USER_ID_HEADER) long userId) {
